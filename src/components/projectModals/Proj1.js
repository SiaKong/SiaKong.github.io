            ...
            <div className="flex flex-col h-screen justify-center items-center ">
                <div class="rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 pb-3">
                        <h5 class="text-gray-900 text-xl font-semibold mb-2 col-start-1 col-end-7">Virtual Line Up</h5>
                    ...
                    <a href="https://devpost.com/software/virtual-line-up">Link to Github</a>
                    </div>
                </div>
            </div>
        </div>
